...
public class ApplicationServiceTestCountApplicationsByCities {
    private final List<Application> applicationList;
    private ApplicationService underTest;
    private final Map<String,Long> expected;

    public ApplicationServiceTestCountApplicationsByCities(List<Application> applicationList, Map<String,Long> expected) {
    ...
    @Test
    public void shouldReturnMapOfTotalAppsFromCities() {
        assertEquals(expected, underTest.countApplicationsByCities(applicationList));
    }
